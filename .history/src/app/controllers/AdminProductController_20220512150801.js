    ...
    if(typeof req.body.sku === 'object') {
        ...
        for(var i in req.body.sku) {
            var sku = {
                ...
                img: req.body.img[i],
                color: {
                    title: req.body.color_name[i],
                    color_code: req.body.color_id[i],
                },
                sizes: []
            }
            object.skus.push(sku);
            for(var j in req.body.sizes) {
                console.log(req.body.sizes[j]);
            }
        }
    }
    // console.log(object.skus[0])

...
const filter = async(req, res, next) => {
    ...
    res.render('TabAdmin/admin-info', { layout: 'mainAdmin.hbs', objHour, user: mongooseToObject(user), product: mongooseToObject(product), order: multipleToObject(order), order2: multipleToObject(order2) });
